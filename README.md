...
```
[GIN-debug] POST   /api/apply_token          --> go-web-utilities.Rest.func1 (3 handlers)
[GIN-debug] POST   /api/tunnels/:tid/set_cache/:key --> go-web-utilities.Rest.func1 (3 handlers)
[GIN-debug] POST   /api/tunnels/:tid/get_cache --> go-web-utilities.Rest.func1 (3 handlers)
